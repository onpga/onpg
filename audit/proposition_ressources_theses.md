# Proposition UX premium - Ressources theses

## Objectif premium
Faire de `/ressources/theses` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. Theses.tsx propose recherche texte, cartes riches, badges diplome, CTA fiche et PDF conditionnel, pagination 6. La proposition vise une evolution incrementale, sans casser la base actuelle.
