# Proposition UX premium - Pharmacies

## Objectif premium
Faire de `/pratique/pharmacies` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. Pharmacies.tsx appelle /public/pharmacies, applique debounce recherche, filtres ville quartier garde ouvert proches, vues cards list map et pagination. La proposition vise une evolution incrementale, sans casser la base actuelle.
