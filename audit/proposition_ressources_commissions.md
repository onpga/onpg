# Proposition UX premium - Ressources commissions

## Objectif premium
Faire de `/ressources/commissions` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. Commissions.tsx affiche commissions avec president missions membres statuts, recherche et pagination 6. La proposition vise une evolution incrementale, sans casser la base actuelle.
