# Proposition UX premium - Ressources hub

## Objectif premium
Faire de `/ressources` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. RessourcesUnifiees.tsx gere onglets decrets lois decisions commissions theses articles communiques, recherche debounced, normalisation et pagination 8. La proposition vise une evolution incrementale, sans casser la base actuelle.
