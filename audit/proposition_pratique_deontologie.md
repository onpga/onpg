# Proposition UX premium - Deontologie

## Objectif premium
Faire de `/pratique/deontologie` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. Deontologie.tsx charge un document actif, corrige URL PDF Cloudinary, affiche iframe de consultation, boutons telecharger et ouvrir. La proposition vise une evolution incrementale, sans casser la base actuelle.
