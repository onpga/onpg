/**
 * Boutons de partage réseaux sociaux — design identique à ArticleDetail (Actualités)
  ...
  return (
    <section className="onpg-share-section">
      ...
      <div className="share-buttons">
        ...
        {/* Facebook */}
        <button onClick={() => share('facebook')} className="share-btn facebook" title="Partager sur Facebook">
        ...
        {/* Twitter / X */}
        <button onClick={() => share('twitter')} className="share-btn twitter" title="Partager sur Twitter">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* LinkedIn */}
        <button onClick={() => share('linkedin')} className="share-btn linkedin" title="Partager sur LinkedIn">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* WhatsApp */}
        <button onClick={() => share('whatsapp')} className="share-btn whatsapp" title="Partager sur WhatsApp">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
