# Proposition UX premium - Ressources photos

## Objectif premium
Faire de `/ressources/photos` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. Photos.tsx mappe albums et photos, hero immersif, filtres recherche categorie album, cartes albums et chargement dedie. La proposition vise une evolution incrementale, sans casser la base actuelle.
