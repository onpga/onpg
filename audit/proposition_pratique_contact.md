# Proposition UX premium - Contact pratique

## Objectif premium
Faire de `/pratique/contact` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. ContactPratique.tsx combine hero, cartes infos contact, carte Google Maps, formulaire valide avec messages succes erreur et envoi POST /public/contact. La proposition vise une evolution incrementale, sans casser la base actuelle.
