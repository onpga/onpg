# Proposition UX premium - Ressources articles

## Objectif premium
Faire de `/ressources/articles` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. Articles.tsx applique recherche, filtres journal categorie type annee, tri date citations downloads, pagination 6. La proposition vise une evolution incrementale, sans casser la base actuelle.
