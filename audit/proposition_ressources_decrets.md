# Proposition UX premium - Ressources decrets

## Objectif premium
Faire de `/ressources/decrets` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. Decrets.tsx gere recherche, statuts juridiques active modified abrogated, cartes detaillees et pagination 8. La proposition vise une evolution incrementale, sans casser la base actuelle.
