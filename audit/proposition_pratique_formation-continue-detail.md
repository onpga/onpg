# Proposition UX premium - Formation continue detail

## Objectif premium
Faire de `/pratique/formation-continue/:id` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. FormationContinueDetail.tsx lit :id, fetchResourceById('formations', id), hero de detail, bloc meta, etats loading erreur introuvable. La proposition vise une evolution incrementale, sans casser la base actuelle.
