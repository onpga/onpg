# Proposition UX premium - Formation continue catalogue

## Objectif premium
Faire de `/pratique/formation-continue` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. FormationContinue.tsx charge formations via fetchResourceData('formations'), hero pratique, filtres categorie et featured, grille .formations-grid, modale detail locale. La proposition vise une evolution incrementale, sans casser la base actuelle.
