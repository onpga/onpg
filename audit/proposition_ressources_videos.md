# Proposition UX premium - Ressources videos

## Objectif premium
Faire de `/ressources/videos` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. Videos.tsx charge videos, filtres recherche categorie, tri date, grille cartes vers detail /ressources/videos/:id. La proposition vise une evolution incrementale, sans casser la base actuelle.
