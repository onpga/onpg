# Proposition UX premium - Ressources decisions

## Objectif premium
Faire de `/ressources/decisions` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. Decisions.tsx structure decisions ordinales, badges issue, parties et keywords, recherche et pagination 8. La proposition vise une evolution incrementale, sans casser la base actuelle.
