# Proposition UX premium - Ressources actualites

## Objectif premium
Faire de `/ressources/actualites` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. RessourcesActualites.tsx utilise useApiCache, filtres categories tags, recherche debounced, cartes article et skeleton loading. La proposition vise une evolution incrementale, sans casser la base actuelle.
