# Proposition UX premium - Ressources communiques

## Objectif premium
Faire de `/ressources/communiques` une page premium orientee resultat: comprehension immediate, action en moins de deux interactions, et experience mobile robuste. Communiques.tsx gere recherche type categorie tri, badges urgent featured, liste cartes et pagination 8. La proposition vise une evolution incrementale, sans casser la base actuelle.
